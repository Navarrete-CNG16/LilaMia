        ...
        <div class="addproduct">
            <form method="POST" action="main/addlist.php">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="color">Nombre de Producto</label>
                    <br>
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1" class="color" >Precio</label>
                    <br>
                    <input type="number" class="form-control" name="precio" required> </div> <br>
